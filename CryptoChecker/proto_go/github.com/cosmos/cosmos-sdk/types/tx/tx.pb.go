...
type TxBody struct {
	...
	// transaction.
	Messages []*protobuf.Any `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"`
	...
	ExtensionOptions []*protobuf.Any `protobuf:"bytes,1023,rep,name=extension_options,json=extensionOptions,proto3" json:"extension_options,omitempty"`
	// extension_options are arbitrary options that can be added by chains
	// when the default options are not sufficient. If any of these are present
	// and can't be handled, they will be ignored
	NonCriticalExtensionOptions []*protobuf.Any `protobuf:"bytes,2047,rep,name=non_critical_extension_options,json=nonCriticalExtensionOptions,proto3" json:"non_critical_extension_options,omitempty"`
}
...
func (x *TxBody) GetMessages() []*protobuf.Any {
	if x != nil {
		return x.Messages
	}
	return nil
...
func (x *TxBody) GetExtensionOptions() []*protobuf.Any {
	if x != nil {
...
func (x *TxBody) GetNonCriticalExtensionOptions() []*protobuf.Any {
	if x != nil {
...
type SignerInfo struct {
	...
	PublicKey *protobuf.Any `protobuf:"bytes,1,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`
...
func (x *SignerInfo) GetPublicKey() *protobuf.Any {
	if x != nil {
		return x.PublicKey
	}
	return nil
