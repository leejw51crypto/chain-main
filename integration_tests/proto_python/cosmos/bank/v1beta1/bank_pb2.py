...
_PARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\362\336\037\035yaml:\"send_enabled,omitempty\"'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\362\336\037%yaml:\"default_send_enabled,omitempty\"'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_SUPPLY = _descriptor.Descriptor(
  ...
  serialized_options=_b('\350\240\037\001\210\240\037\000\230\240\037\000\322\264-5*github.com/cosmos/cosmos-sdk/x/bank/exported.SupplyI'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
SendEnabled = _reflection.GeneratedProtocolMessageType('SendEnabled', (_message.Message,), dict(
...
DenomUnit = _reflection.GeneratedProtocolMessageType('DenomUnit', (_message.Message,), dict(
