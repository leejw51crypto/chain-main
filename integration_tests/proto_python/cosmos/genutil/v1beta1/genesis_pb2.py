...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z,github.com/cosmos/cosmos-sdk/x/genutil/types'),
...
_GENESISSTATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\372\336\037\030encoding/json.RawMessage\352\336\037\006gentxs\362\336\037\ryaml:\"gentxs\"'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
