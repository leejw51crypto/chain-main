...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z-github.com/cosmos/cosmos-sdk/x/evidence/types'),
...
_QUERYEVIDENCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\372\336\0374github.com/tendermint/tendermint/libs/bytes.HexBytes'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0023\0221/cosmos/evidence/v1beta1/evidence/{evidence_hash}'),
  ),
  _descriptor.MethodDescriptor(
    name='AllEvidence',
