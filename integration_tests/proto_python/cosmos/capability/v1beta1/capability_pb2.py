...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z/github.com/cosmos/cosmos-sdk/x/capability/types'),
...
_CAPABILITY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\362\336\037\014yaml:\"index\"'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_OWNER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\362\336\037\ryaml:\"module\"'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\362\336\037\013yaml:\"name\"'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
  ...
  serialized_options=_b('\230\240\037\000\210\240\037\000'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
