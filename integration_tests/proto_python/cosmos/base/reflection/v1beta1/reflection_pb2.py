...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z3github.com/cosmos/cosmos-sdk/client/grpc/reflection'),
...
ListAllInterfacesRequest = _reflection.GeneratedProtocolMessageType('ListAllInterfacesRequest', (_message.Message,), dict(
...
ListAllInterfacesResponse = _reflection.GeneratedProtocolMessageType('ListAllInterfacesResponse', (_message.Message,), dict(
...
ListImplementationsRequest = _reflection.GeneratedProtocolMessageType('ListImplementationsRequest', (_message.Message,), dict(
...
ListImplementationsResponse = _reflection.GeneratedProtocolMessageType('ListImplementationsResponse', (_message.Message,), dict(
...
_REFLECTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002,\022*/cosmos/base/reflection/v1beta1/interfaces'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002M\022K/cosmos/base/reflection/v1beta1/interfaces/{interface_name}/implementations'),
  ),
])
