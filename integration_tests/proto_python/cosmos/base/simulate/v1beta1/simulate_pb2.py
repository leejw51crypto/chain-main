...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z1github.com/cosmos/cosmos-sdk/client/grpc/simulate'),
...
_SIMULATESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002(\"&/cosmos/base/simulate/v1beta1/simulate'),
  ),
])
