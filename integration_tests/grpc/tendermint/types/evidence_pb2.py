...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,tendermint_dot_types_dot_types__pb2.DESCRIPTOR,])
...
_EVIDENCEDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='evidence', full_name='tendermint.types.EvidenceData.evidence', index=0,
...
EvidenceData = _reflection.GeneratedProtocolMessageType('EvidenceData', (_message.Message,), {
