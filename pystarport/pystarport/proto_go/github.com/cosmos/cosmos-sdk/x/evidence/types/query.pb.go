...
type QueryEvidenceResponse struct {
	...
	Evidence *protobuf.Any `protobuf:"bytes,1,opt,name=evidence,proto3" json:"evidence,omitempty"`
}
...
func (x *QueryEvidenceResponse) GetEvidence() *protobuf.Any {
	if x != nil {
		return x.Evidence
	}
	return nil
...
type QueryAllEvidenceResponse struct {
	...
	Evidence []*protobuf.Any `protobuf:"bytes,1,rep,name=evidence,proto3" json:"evidence,omitempty"`
...
func (x *QueryAllEvidenceResponse) GetEvidence() []*protobuf.Any {
	if x != nil {
		return x.Evidence
	}
	return nil
