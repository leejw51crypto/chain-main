...
type LegacyAminoPubKey struct {
	...
	PublicKeys []*protobuf.Any `protobuf:"bytes,2,rep,name=public_keys,json=publicKeys,proto3" json:"public_keys,omitempty"`
}
...
func (x *LegacyAminoPubKey) GetPublicKeys() []*protobuf.Any {
	if x != nil {
		return x.PublicKeys
	}
	return nil
...
var file_cosmos_crypto_multisig_keys_proto_goTypes = []interface{}{
	...
	(*protobuf.Any)(nil),      // 1: google.protobuf.Any
}
