...
type QueryAccountResponse struct {
	...
	Account *protobuf.Any `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"`
}
...
func (x *QueryAccountResponse) GetAccount() *protobuf.Any {
	if x != nil {
		return x.Account
	}
	return nil
...
var file_cosmos_auth_v1beta1_query_proto_rawDesc = []byte{
	...
	0x73, 0x3a, 0x08, 0xe8, 0xa0, 0x1f, 0x00, 0x88, 0xa0, 0x1f, 0x00, 0x22, 0x54, 0x0a, 0x14, 0x51,
	...
	0x00, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x32, 0x9c, 0x02, 0x0a, 0x05, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x12, 0x8f, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12,
	...
	0x72, 0x65, 0x73, 0x73, 0x7d, 0x12, 0x80, 0x01, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73,
	...
	0x31, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68,
...
var file_cosmos_auth_v1beta1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cosmos_auth_v1beta1_query_proto_goTypes = []interface{}{
	...
	(*QueryParamsRequest)(nil),   // 2: cosmos.auth.v1beta1.QueryParamsRequest
	(*QueryParamsResponse)(nil),  // 3: cosmos.auth.v1beta1.QueryParamsResponse
...
var file_cosmos_auth_v1beta1_query_proto_depIdxs = []int32{
	...
	5, // 1: cosmos.auth.v1beta1.QueryParamsResponse.params:type_name -> cosmos.auth.v1beta1.Params
	0, // 2: cosmos.auth.v1beta1.Query.Account:input_type -> cosmos.auth.v1beta1.QueryAccountRequest
	2, // 3: cosmos.auth.v1beta1.Query.Params:input_type -> cosmos.auth.v1beta1.QueryParamsRequest
	1, // 4: cosmos.auth.v1beta1.Query.Account:output_type -> cosmos.auth.v1beta1.QueryAccountResponse
	3, // 5: cosmos.auth.v1beta1.Query.Params:output_type -> cosmos.auth.v1beta1.QueryParamsResponse
