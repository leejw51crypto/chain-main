...
func (x *CanonicalProposal) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *CanonicalVote) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
var file_tendermint_types_canonical_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
